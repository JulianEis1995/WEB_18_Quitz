...
class User extends Database
{
    ...
    {
        $sql = "SELECT `pid`,`pwd` FROM `tplayer` WHERE `username`='" . $this->escapeString($username) . "'";
    ...
    {
        $id = intval($id);
        $sql = "SELECT * FROM `tplayer` WHERE `PID`=".$id;
    ...
    public static function existsWithUsername($username)
    {
        ...
        $sql = "SELECT COUNT(`pid`) AS num FROM `tplayer` WHERE `username`='".$db->escapeString($username)."'";
        $result = $db->query($sql);
    ...
    public static function createUser($data)
    {
        ...
        $sql = "INSERT INTO `tplayer`(`username`,`pwd`) VALUES('".$username."','".$password."')";
        $db->query($sql);
    }
